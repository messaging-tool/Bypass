...
ALLOWED_HOSTS=["127.0.0.1", "localhost", "bypassdm.com", "bypassdm.up.railway.app"]
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'LandingPage', 'templates', 'LandingPage', 'static'),
]
...
CSRF_TRUSTED_ORIGINS = ['https://bypassdm.com']
